...
public class EntityUtil {
    ...
    private final String moduleName = "mayujing"; // 数据库名称

    private final String bean_path = "E:\\day\\workspace\\myj-shopping-vue\\src\\main\\java\\com\\myj\\shopping\\model";

    private final String mapper_path = "E:\\day\\workspace\\myj-shopping-vue\\src\\main\\java\\com\\myj\\shopping\\dao";

    private final String xml_path = "E:\\day\\workspace\\myj-shopping-vue\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.myj.shopping.model";// model的包所在

    private final String dao_package = "com.myj.shopping.dao";// dao的包所在
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.mmozaiayujing.seckill.common.util.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
